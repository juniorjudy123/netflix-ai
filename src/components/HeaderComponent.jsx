		...
		<div className=" absolute px-10 py-10 bg-gradient-to-b from-black z-10 opacity-85 w-full flex justify-between">
			...
			{user && (
				<div className="flex p-2 ">
					<img
						className="w12 h-10 rounded-sm m-2 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 "
						alt="userLogo"
						src={user.photoURL}
					/>
